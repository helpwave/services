...
export class WardServiceClient {
  ...
  getWardOverviews(
    request: proto_services_ward_svc_v1_ward_svc_pb.GetWardOverviewsRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: proto_services_ward_svc_v1_ward_svc_pb.GetWardOverviewsResponse) => void
  ): grpcWeb.ClientReadableStream<proto_services_ward_svc_v1_ward_svc_pb.GetWardOverviewsResponse>;
...
export class WardServicePromiseClient {
  ...
  getWardOverviews(
    request: proto_services_ward_svc_v1_ward_svc_pb.GetWardOverviewsRequest,
    metadata?: grpcWeb.Metadata
  ): Promise<proto_services_ward_svc_v1_ward_svc_pb.GetWardOverviewsResponse>;
