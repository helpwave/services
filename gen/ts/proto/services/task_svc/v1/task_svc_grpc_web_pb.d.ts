...
export class TaskServiceClient {
  ...
  getTasksByPatientByStatus(
    request: proto_services_task_svc_v1_task_svc_pb.GetTasksByPatientByStatusRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: proto_services_task_svc_v1_task_svc_pb.GetTasksByPatientByStatusResponse) => void
  ): grpcWeb.ClientReadableStream<proto_services_task_svc_v1_task_svc_pb.GetTasksByPatientByStatusResponse>;
...
export class TaskServicePromiseClient {
  ...
  getTasksByPatientByStatus(
    request: proto_services_task_svc_v1_task_svc_pb.GetTasksByPatientByStatusRequest,
    metadata?: grpcWeb.Metadata
  ): Promise<proto_services_task_svc_v1_task_svc_pb.GetTasksByPatientByStatusResponse>;
