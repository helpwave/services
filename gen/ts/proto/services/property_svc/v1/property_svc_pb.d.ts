...
export class GetPropertiesBySubjectTypeRequest extends jspb.Message {
  getSubjectType(): proto_services_property_svc_v1_types_pb.SubjectType;
  setSubjectType(value: proto_services_property_svc_v1_types_pb.SubjectType): GetPropertiesBySubjectTypeRequest;
...
export namespace GetPropertiesBySubjectTypeResponse {
  ...
  export class Property extends jspb.Message {
    ...
    getSubjectType(): proto_services_property_svc_v1_types_pb.SubjectType;
    setSubjectType(value: proto_services_property_svc_v1_types_pb.SubjectType): Property;

    getFieldType(): proto_services_property_svc_v1_types_pb.FieldType;
    setFieldType(value: proto_services_property_svc_v1_types_pb.FieldType): Property;
