...
export class PropertyValueServiceClient {
  ...
  createPropertyValue(
    request: proto_services_property_svc_v1_property_value_svc_pb.CreatePropertyValueRequest,
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: proto_services_property_svc_v1_property_value_svc_pb.CreatePropertyValueResponse) => void
  ): grpcWeb.ClientReadableStream<proto_services_property_svc_v1_property_value_svc_pb.CreatePropertyValueResponse>;
...
export class PropertyValueServicePromiseClient {
  ...
  ): Promise<proto_services_property_svc_v1_property_value_svc_pb.CreatePropertyValueResponse>;
