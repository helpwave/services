...
goog.exportSymbol('proto.services.tasks_svc.v1.GetRoomsByWardRequest', null, global);
goog.exportSymbol('proto.services.tasks_svc.v1.GetRoomsByWardResponse', null, global);
goog.exportSymbol('proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room', null, global);
goog.exportSymbol('proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed', null, global);
 ...
 * @constructor
 */
proto.services.tasks_svc.v1.GetRoomsByWardRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.tasks_svc.v1.GetRoomsByWardRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.tasks_svc.v1.GetRoomsByWardRequest.displayName = 'proto.services.tasks_svc.v1.GetRoomsByWardRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.services.tasks_svc.v1.GetRoomsByWardResponse.repeatedFields_, null);
};
goog.inherits(proto.services.tasks_svc.v1.GetRoomsByWardResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.tasks_svc.v1.GetRoomsByWardResponse.displayName = 'proto.services.tasks_svc.v1.GetRoomsByWardResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.repeatedFields_, null);
};
goog.inherits(proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.displayName = 'proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.displayName = 'proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.services.tasks_svc.v1.GetRoomsByWardRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.services.tasks_svc.v1.GetRoomsByWardRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.tasks_svc.v1.GetRoomsByWardRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardRequest}
 */
proto.services.tasks_svc.v1.GetRoomsByWardRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.tasks_svc.v1.GetRoomsByWardRequest;
  return proto.services.tasks_svc.v1.GetRoomsByWardRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardRequest}
 */
proto.services.tasks_svc.v1.GetRoomsByWardRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.tasks_svc.v1.GetRoomsByWardRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.tasks_svc.v1.GetRoomsByWardRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.tasks_svc.v1.GetRoomsByWardRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getWardId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.services.tasks_svc.v1.GetRoomsByWardRequest.prototype.getWardId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardRequest} returns this
 */
proto.services.tasks_svc.v1.GetRoomsByWardRequest.prototype.setWardId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @const
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.services.tasks_svc.v1.GetRoomsByWardResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    roomsList: jspb.Message.toObjectList(msg.getRoomsList(),
    proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.tasks_svc.v1.GetRoomsByWardResponse;
  return proto.services.tasks_svc.v1.GetRoomsByWardResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room;
      reader.readMessage(value,proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.deserializeBinaryFromReader);
      msg.addRooms(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.tasks_svc.v1.GetRoomsByWardResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRoomsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.serializeBinaryToWriter
    );
  }
};
 ...
 * @const
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.toObject = function(opt_includeInstance) {
  return proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    name: jspb.Message.getFieldWithDefault(msg, 2, ""),
    bedsList: jspb.Message.toObjectList(msg.getBedsList(),
    proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.toObject, includeInstance),
    wardId: jspb.Message.getFieldWithDefault(msg, 5, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room;
  return proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed;
      reader.readMessage(value,proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.deserializeBinaryFromReader);
      msg.addBeds(value);
      break;
    case 5:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @return {!Uint8Array}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.serializeBinaryToWriter
    );
  }
  f = message.getWardId();
  if (f.length > 0) {
 ...
 * @return {!Object}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.prototype.toObject = function(opt_includeInstance) {
  return proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    name: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed;
  return proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed} returns this
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed} returns this
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room} returns this
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room} returns this
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
...
/**
 * repeated Bed beds = 3;
 * @return {!Array<!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed>}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.getBedsList = function() {
  return /** @type{!Array<!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed, 3));
};


/**
 * @param {!Array<!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed>} value
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room} returns this
*/
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.setBedsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 3, value);
};


/**
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed=} opt_value
 * @param {number=} opt_index
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.addBeds = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.Bed, opt_index);
};
 ...
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room} returns this
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.clearBedsList = function() {
  return this.setBedsList([]);
};
 ...
 * @return {string}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.getWardId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room} returns this
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room.prototype.setWardId = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
...
/**
 * repeated Room rooms = 1;
 * @return {!Array<!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room>}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.prototype.getRoomsList = function() {
  return /** @type{!Array<!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room, 1));
};


/**
 * @param {!Array<!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room>} value
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse} returns this
*/
proto.services.tasks_svc.v1.GetRoomsByWardResponse.prototype.setRoomsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room=} opt_value
 * @param {number=} opt_index
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room}
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.prototype.addRooms = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.services.tasks_svc.v1.GetRoomsByWardResponse.Room, opt_index);
};
 ...
 * @return {!proto.services.tasks_svc.v1.GetRoomsByWardResponse} returns this
 */
proto.services.tasks_svc.v1.GetRoomsByWardResponse.prototype.clearRoomsList = function() {
  return this.setRoomsList([]);
};
