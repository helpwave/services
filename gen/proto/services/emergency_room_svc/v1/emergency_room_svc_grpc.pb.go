...
const (
	EmergencyRoomService_CreateER_FullMethodName                = "/proto.services.emergency_room_svc.v1.EmergencyRoomService/CreateER"
	EmergencyRoomService_GetER_FullMethodName                   = "/proto.services.emergency_room_svc.v1.EmergencyRoomService/GetER"
	EmergencyRoomService_GetERs_FullMethodName                  = "/proto.services.emergency_room_svc.v1.EmergencyRoomService/GetERs"
	EmergencyRoomService_UpdateER_FullMethodName                = "/proto.services.emergency_room_svc.v1.EmergencyRoomService/UpdateER"
	EmergencyRoomService_AddDepartmentsToER_FullMethodName      = "/proto.services.emergency_room_svc.v1.EmergencyRoomService/AddDepartmentsToER"
	EmergencyRoomService_RemoveDepartmentsFromER_FullMethodName = "/proto.services.emergency_room_svc.v1.EmergencyRoomService/RemoveDepartmentsFromER"
	EmergencyRoomService_DeleteER_FullMethodName                = "/proto.services.emergency_room_svc.v1.EmergencyRoomService/DeleteER"
)
...
func (c *emergencyRoomServiceClient) GetER(ctx context.Context, in *GetERRequest, opts ...grpc.CallOption) (*GetERResponse, error) {
	out := new(GetERResponse)
	err := c.cc.Invoke(ctx, EmergencyRoomService_GetER_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emergencyRoomServiceClient) GetERs(ctx context.Context, in *GetERsRequest, opts ...grpc.CallOption) (*GetERsResponse, error) {
	...
	err := c.cc.Invoke(ctx, EmergencyRoomService_GetERs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emergencyRoomServiceClient) UpdateER(ctx context.Context, in *UpdateERRequest, opts ...grpc.CallOption) (*UpdateERResponse, error) {
	...
	err := c.cc.Invoke(ctx, EmergencyRoomService_UpdateER_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emergencyRoomServiceClient) AddDepartmentsToER(ctx context.Context, in *AddDepartmentsToERRequest, opts ...grpc.CallOption) (*AddDepartmentsToERResponse, error) {
	...
	err := c.cc.Invoke(ctx, EmergencyRoomService_AddDepartmentsToER_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emergencyRoomServiceClient) RemoveDepartmentsFromER(ctx context.Context, in *RemoveDepartmentsFromERRequest, opts ...grpc.CallOption) (*RemoveDepartmentsFromERResponse, error) {
	...
	err := c.cc.Invoke(ctx, EmergencyRoomService_RemoveDepartmentsFromER_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *emergencyRoomServiceClient) DeleteER(ctx context.Context, in *DeleteERRequest, opts ...grpc.CallOption) (*DeleteERResponse, error) {
	...
	err := c.cc.Invoke(ctx, EmergencyRoomService_DeleteER_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _EmergencyRoomService_CreateER_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmergencyRoomService_CreateER_FullMethodName,
	}
...
func _EmergencyRoomService_GetER_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmergencyRoomService_GetER_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmergencyRoomServiceServer).GetER(ctx, req.(*GetERRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EmergencyRoomService_GetERs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmergencyRoomService_GetERs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmergencyRoomService_UpdateER_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmergencyRoomService_UpdateER_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmergencyRoomService_AddDepartmentsToER_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmergencyRoomService_AddDepartmentsToER_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmergencyRoomService_RemoveDepartmentsFromER_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmergencyRoomService_RemoveDepartmentsFromER_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _EmergencyRoomService_DeleteER_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmergencyRoomService_DeleteER_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var EmergencyRoomService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.services.emergency_room_svc.v1.EmergencyRoomService",
	...
	Metadata: "proto/services/emergency_room_svc/v1/emergency_room_svc.proto",
}
