...
type FilterUpdate struct {
	...
	AppendToAlwaysInclude []string `protobuf:"bytes,1,rep,name=append_to_always_include,json=appendToAlwaysInclude,proto3" json:"append_to_always_include,omitempty"` // @gotags: validate:"dive,uuid4"
	// remove property_id to the always_include list, also see append_to_always_include
	RemoveFromAlwaysInclude []string `protobuf:"bytes,2,rep,name=remove_from_always_include,json=removeFromAlwaysInclude,proto3" json:"remove_from_always_include,omitempty"` // @gotags: validate:"dive,uuid4"
	// append property_id to the dont_always_include list, also see append_to_always_include
	AppendToDontAlwaysInclude []string `protobuf:"bytes,3,rep,name=append_to_dont_always_include,json=appendToDontAlwaysInclude,proto3" json:"append_to_dont_always_include,omitempty"` // @gotags: validate:"dive,uuid4"
	// remove property_id to the dont_always_include list, also see append_to_always_include
	RemoveFromDontAlwaysInclude []string `protobuf:"bytes,4,rep,name=remove_from_dont_always_include,json=removeFromDontAlwaysInclude,proto3" json:"remove_from_dont_always_include,omitempty"` // @gotags: validate:"dive,uuid4"
}
...
type UpdatePropertyViewRuleRequest struct {
	...
	FilterUpdate *FilterUpdate `protobuf:"bytes,1,opt,name=filter_update,json=filterUpdate,proto3" json:"filter_update,omitempty"` // @gotags: validate:"required"
...
var file_services_property_svc_v1_property_views_svc_proto_rawDesc = []byte{
	...
	0xcb, 0x01, 0x0a, 0x1d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72,
	...
	0x65, 0x72, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x22, 0x20, 0x0a,
	0x1e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x56,
	0x69, 0x65, 0x77, 0x52, 0x75, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32,
	0xa6, 0x01, 0x0a, 0x14, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x56, 0x69, 0x65, 0x77,
	0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x8d, 0x01, 0x0a, 0x16, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x56, 0x69, 0x65, 0x77, 0x52,
	0x75, 0x6c, 0x65, 0x12, 0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x70,
	...
	0x77, 0x52, 0x75, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x38, 0x2e, 0x73,
	...
	0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x56, 0x69, 0x65, 0x77, 0x52, 0x75, 0x6c, 0x65, 0x52, 0x65,
...
var file_services_property_svc_v1_property_views_svc_proto_depIdxs = []int32{
	...
	1, // 2: services.property_svc.v1.PropertyViewsService.UpdatePropertyViewRule:input_type -> services.property_svc.v1.UpdatePropertyViewRuleRequest
	2, // 3: services.property_svc.v1.PropertyViewsService.UpdatePropertyViewRule:output_type -> services.property_svc.v1.UpdatePropertyViewRuleResponse
