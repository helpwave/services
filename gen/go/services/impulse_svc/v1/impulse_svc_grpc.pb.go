...
const (
	ImpulseService_CreateUser_FullMethodName          = "/services.impulse_svc.v1.ImpulseService/CreateUser"
	ImpulseService_UpdateUser_FullMethodName          = "/services.impulse_svc.v1.ImpulseService/UpdateUser"
	ImpulseService_TrackChallenge_FullMethodName      = "/services.impulse_svc.v1.ImpulseService/TrackChallenge"
	ImpulseService_GetActiveChallenges_FullMethodName = "/services.impulse_svc.v1.ImpulseService/GetActiveChallenges"
	ImpulseService_GetScore_FullMethodName            = "/services.impulse_svc.v1.ImpulseService/GetScore"
	ImpulseService_GetRewards_FullMethodName          = "/services.impulse_svc.v1.ImpulseService/GetRewards"
	ImpulseService_GetAllRewards_FullMethodName       = "/services.impulse_svc.v1.ImpulseService/GetAllRewards"
	ImpulseService_GetAllTeams_FullMethodName         = "/services.impulse_svc.v1.ImpulseService/GetAllTeams"
	ImpulseService_StatsForTeamByUser_FullMethodName  = "/services.impulse_svc.v1.ImpulseService/StatsForTeamByUser"
	ImpulseService_Verification_FullMethodName        = "/services.impulse_svc.v1.ImpulseService/Verification"
)
...
func (c *impulseServiceClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpulseService_CreateUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *impulseServiceClient) UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*UpdateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpulseService_UpdateUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *impulseServiceClient) TrackChallenge(ctx context.Context, in *TrackChallengeRequest, opts ...grpc.CallOption) (*TrackChallengeResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpulseService_TrackChallenge_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *impulseServiceClient) GetActiveChallenges(ctx context.Context, in *GetActiveChallengesRequest, opts ...grpc.CallOption) (*GetActiveChallengesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpulseService_GetActiveChallenges_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *impulseServiceClient) GetScore(ctx context.Context, in *GetScoreRequest, opts ...grpc.CallOption) (*GetScoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpulseService_GetScore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *impulseServiceClient) GetRewards(ctx context.Context, in *GetRewardsRequest, opts ...grpc.CallOption) (*GetRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpulseService_GetRewards_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *impulseServiceClient) GetAllRewards(ctx context.Context, in *GetAllRewardsRequest, opts ...grpc.CallOption) (*GetAllRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpulseService_GetAllRewards_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *impulseServiceClient) GetAllTeams(ctx context.Context, in *GetAllTeamsRequest, opts ...grpc.CallOption) (*GetAllTeamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpulseService_GetAllTeams_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *impulseServiceClient) StatsForTeamByUser(ctx context.Context, in *StatsForTeamByUserRequest, opts ...grpc.CallOption) (*StatsForTeamByUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpulseService_StatsForTeamByUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *impulseServiceClient) Verification(ctx context.Context, in *VerificationRequest, opts ...grpc.CallOption) (*VerificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImpulseService_Verification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var ImpulseService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "services.impulse_svc.v1.ImpulseService",
