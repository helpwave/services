...
const (
	PropertySetService_CreatePropertySet_FullMethodName = "/proto.services.property_svc.v1.PropertySetService/CreatePropertySet"
	PropertySetService_GetPropertySet_FullMethodName    = "/proto.services.property_svc.v1.PropertySetService/GetPropertySet"
)
...
func (c *propertySetServiceClient) CreatePropertySet(ctx context.Context, in *CreatePropertySetRequest, opts ...grpc.CallOption) (*CreatePropertySetResponse, error) {
	...
	err := c.cc.Invoke(ctx, PropertySetService_CreatePropertySet_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *propertySetServiceClient) GetPropertySet(ctx context.Context, in *GetPropertySetRequest, opts ...grpc.CallOption) (*GetPropertySetResponse, error) {
	...
	err := c.cc.Invoke(ctx, PropertySetService_GetPropertySet_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var PropertySetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.services.property_svc.v1.PropertySetService",
	...
	Metadata: "proto/services/property_svc/v1/property_set_svc.proto",
}
