...
class CreateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..e<$23.TaskStatus>(6, _omitFieldNames ? '' : 'initialStatus', $pb.PbFieldType.OE, defaultOrMaker: $23.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $23.TaskStatus.valueOf, enumValues: $23.TaskStatus.values)
  ...
  @$pb.TagNumber(6)
  $23.TaskStatus get initialStatus => $_getN(5);
  @$pb.TagNumber(6)
  set initialStatus($23.TaskStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class UpdateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..e<$23.TaskStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $23.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $23.TaskStatus.valueOf, enumValues: $23.TaskStatus.values)
  ...
  @$pb.TagNumber(5)
  $23.TaskStatus get status => $_getN(4);
  @$pb.TagNumber(5)
  set status($23.TaskStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class GetTaskResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTaskResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..e<$23.TaskStatus>(6, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $23.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $23.TaskStatus.valueOf, enumValues: $23.TaskStatus.values)
  ...
  @$pb.TagNumber(6)
  $23.TaskStatus get status => $_getN(5);
  @$pb.TagNumber(6)
  set status($23.TaskStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class GetTasksByPatientResponse_Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTasksByPatientResponse.Task', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..aOS(3, _omitFieldNames ? '' : 'description')
    ..e<$23.TaskStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $23.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $23.TaskStatus.valueOf, enumValues: $23.TaskStatus.values)
  ...
  @$pb.TagNumber(4)
  $23.TaskStatus get status => $_getN(3);
  @$pb.TagNumber(4)
  set status($23.TaskStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
