...
class Date extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Date', package: const $pb.PackageName(_omitMessageNames ? '' : 'libs.common.v1'), createEmptyInstance: create)
    ..aOM<$21.Timestamp>(1, _omitFieldNames ? '' : 'date', subBuilder: $21.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $21.Timestamp get date => $_getN(0);
  @$pb.TagNumber(1)
  set date($21.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDate() => $_has(0);
  @$pb.TagNumber(1)
  void clearDate() => clearField(1);
  @$pb.TagNumber(1)
  $21.Timestamp ensureDate() => $_ensure(0);
}
