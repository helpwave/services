...
class CreatePropertyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreatePropertyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.property_svc.v1'), createEmptyInstance: create)
    ..oo(0, [9])
    ..e<$19.SubjectType>(2, _omitFieldNames ? '' : 'subjectType', $pb.PbFieldType.OE, defaultOrMaker: $19.SubjectType.SUBJECT_TYPE_UNSPECIFIED, valueOf: $19.SubjectType.valueOf, enumValues: $19.SubjectType.values)
    ..e<$19.FieldType>(3, _omitFieldNames ? '' : 'fieldType', $pb.PbFieldType.OE, defaultOrMaker: $19.FieldType.FIELD_TYPE_UNSPECIFIED, valueOf: $19.FieldType.valueOf, enumValues: $19.FieldType.values)
  ...
  @$pb.TagNumber(2)
  $19.SubjectType get subjectType => $_getN(0);
  @$pb.TagNumber(2)
  set subjectType($19.SubjectType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set fieldType($19.FieldType v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class GetPropertyResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $19.SubjectType get subjectType => $_getN(1);
  @$pb.TagNumber(2)
  set subjectType($19.SubjectType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $19.FieldType get fieldType => $_getN(2);
  @$pb.TagNumber(3)
  set fieldType($19.FieldType v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class GetPropertiesBySubjectTypeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPropertiesBySubjectTypeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.property_svc.v1'), createEmptyInstance: create)
    ..e<$19.SubjectType>(1, _omitFieldNames ? '' : 'subjectType', $pb.PbFieldType.OE, defaultOrMaker: $19.SubjectType.SUBJECT_TYPE_UNSPECIFIED, valueOf: $19.SubjectType.valueOf, enumValues: $19.SubjectType.values)
    ..hasRequiredFields = false
  ;
  ...
  $19.SubjectType get subjectType => $_getN(0);
  @$pb.TagNumber(1)
  set subjectType($19.SubjectType v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSubjectType() => $_has(0);
  @$pb.TagNumber(1)
