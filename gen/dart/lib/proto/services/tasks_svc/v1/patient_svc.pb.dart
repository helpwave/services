...
class GetPatientDetailsResponse_Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPatientDetailsResponse.Task', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..e<$20.TaskStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $20.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $20.TaskStatus.valueOf, enumValues: $20.TaskStatus.values)
  ...
  @$pb.TagNumber(4)
  $20.TaskStatus get status => $_getN(3);
  @$pb.TagNumber(4)
  set status($20.TaskStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
