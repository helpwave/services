...
class GetTaskResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTaskResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$14.Timestamp>(7, _omitFieldNames ? '' : 'createdAt', subBuilder: $14.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $14.Timestamp get createdAt => $_getN(6);
  @$pb.TagNumber(7)
  set createdAt($14.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCreatedAt() => $_has(6);
  @$pb.TagNumber(7)
  void clearCreatedAt() => clearField(7);
  @$pb.TagNumber(7)
  $14.Timestamp ensureCreatedAt() => $_ensure(6);
}
