...
class CreateTaskRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  $16.Timestamp get dueAt => $_getN(4);
  @$pb.TagNumber(5)
  set dueAt($16.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class UpdateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$16.Timestamp>(4, _omitFieldNames ? '' : 'dueAt', subBuilder: $16.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $16.Timestamp get dueAt => $_getN(3);
  @$pb.TagNumber(4)
  set dueAt($16.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDueAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearDueAt() => clearField(4);
  @$pb.TagNumber(4)
  $16.Timestamp ensureDueAt() => $_ensure(3);
}
...
class GetTasksByPatientResponse_Task extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  $16.Timestamp get dueAt => $_getN(7);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(8)
  $16.Timestamp ensureDueAt() => $_ensure(7);
