...
class CreateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$19.Timestamp>(5, _omitFieldNames ? '' : 'dueAt', subBuilder: $19.Timestamp.create)
    ..e<$20.TaskStatus>(6, _omitFieldNames ? '' : 'initialStatus', $pb.PbFieldType.OE, defaultOrMaker: $20.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $20.TaskStatus.valueOf, enumValues: $20.TaskStatus.values)
  ...
  @$pb.TagNumber(5)
  $19.Timestamp get dueAt => $_getN(4);
  @$pb.TagNumber(5)
  set dueAt($19.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDueAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearDueAt() => clearField(5);
  @$pb.TagNumber(5)
  $19.Timestamp ensureDueAt() => $_ensure(4);

  @$pb.TagNumber(6)
  $20.TaskStatus get initialStatus => $_getN(5);
  @$pb.TagNumber(6)
  set initialStatus($20.TaskStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class UpdateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$19.Timestamp>(4, _omitFieldNames ? '' : 'dueAt', subBuilder: $19.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $19.Timestamp get dueAt => $_getN(3);
  @$pb.TagNumber(4)
  set dueAt($19.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDueAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearDueAt() => clearField(4);
  @$pb.TagNumber(4)
  $19.Timestamp ensureDueAt() => $_ensure(3);
}
...
class GetTaskResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTaskResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..e<$20.TaskStatus>(6, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $20.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $20.TaskStatus.valueOf, enumValues: $20.TaskStatus.values)
    ..aOM<$19.Timestamp>(7, _omitFieldNames ? '' : 'createdAt', subBuilder: $19.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $20.TaskStatus get status => $_getN(5);
  @$pb.TagNumber(6)
  set status($20.TaskStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class GetTasksByPatientResponse_Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTasksByPatientResponse.Task', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$19.Timestamp>(8, _omitFieldNames ? '' : 'dueAt', subBuilder: $19.Timestamp.create)
    ...
    ..aOM<$19.Timestamp>(11, _omitFieldNames ? '' : 'createdAt', subBuilder: $19.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $19.Timestamp get dueAt => $_getN(7);
  @$pb.TagNumber(8)
  set dueAt($19.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasDueAt() => $_has(7);
  @$pb.TagNumber(8)
  void clearDueAt() => clearField(8);
  @$pb.TagNumber(8)
  $19.Timestamp ensureDueAt() => $_ensure(7);
  ...
  @$pb.TagNumber(11)
  $19.Timestamp get createdAt => $_getN(10);
  @$pb.TagNumber(11)
  set createdAt($19.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasCreatedAt() => $_has(10);
  @$pb.TagNumber(11)
  void clearCreatedAt() => clearField(11);
  @$pb.TagNumber(11)
  $19.Timestamp ensureCreatedAt() => $_ensure(10);
}
...
class GetTasksByPatientSortedByStatusResponse_Task extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  $19.Timestamp get dueAt => $_getN(6);
  @$pb.TagNumber(8)
  set dueAt($19.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  void clearDueAt() => clearField(8);
  @$pb.TagNumber(8)
  $19.Timestamp ensureDueAt() => $_ensure(6);
  ...
  @$pb.TagNumber(11)
  $19.Timestamp get createdAt => $_getN(9);
  @$pb.TagNumber(11)
  set createdAt($19.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  void clearCreatedAt() => clearField(11);
  @$pb.TagNumber(11)
  $19.Timestamp ensureCreatedAt() => $_ensure(9);
}
