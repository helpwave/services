...
class CreateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.task_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$11.Timestamp>(5, _omitFieldNames ? '' : 'dueAt', subBuilder: $11.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $11.Timestamp get dueAt => $_getN(4);
  @$pb.TagNumber(5)
  set dueAt($11.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDueAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearDueAt() => clearField(5);
  @$pb.TagNumber(5)
  $11.Timestamp ensureDueAt() => $_ensure(4);
...
class GetTaskResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTaskResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.task_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$11.Timestamp>(8, _omitFieldNames ? '' : 'dueAt', subBuilder: $11.Timestamp.create)
...
class UpdateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.task_svc.v1'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..aOS(3, _omitFieldNames ? '' : 'description')
    ..aOM<$11.Timestamp>(4, _omitFieldNames ? '' : 'dueAt', subBuilder: $11.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $11.Timestamp get dueAt => $_getN(3);
  @$pb.TagNumber(4)
  set dueAt($11.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDueAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearDueAt() => clearField(4);
  @$pb.TagNumber(4)
  $11.Timestamp ensureDueAt() => $_ensure(3);
