...
class CreatePropertyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreatePropertyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.property_svc.v1'), createEmptyInstance: create)
    ..oo(0, [9])
    ..e<$6.SubjectType>(2, _omitFieldNames ? '' : 'subjectType', $pb.PbFieldType.OE, defaultOrMaker: $6.SubjectType.SUBJECT_TYPE_UNSPECIFIED, valueOf: $6.SubjectType.valueOf, enumValues: $6.SubjectType.values)
    ..e<$6.FieldType>(3, _omitFieldNames ? '' : 'fieldType', $pb.PbFieldType.OE, defaultOrMaker: $6.FieldType.FIELD_TYPE_UNSPECIFIED, valueOf: $6.FieldType.valueOf, enumValues: $6.FieldType.values)
  ...
  @$pb.TagNumber(2)
  $6.SubjectType get subjectType => $_getN(0);
  @$pb.TagNumber(2)
  set subjectType($6.SubjectType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set fieldType($6.FieldType v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class GetPropertyResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $6.SubjectType get subjectType => $_getN(1);
  @$pb.TagNumber(2)
  set subjectType($6.SubjectType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $6.FieldType get fieldType => $_getN(2);
  @$pb.TagNumber(3)
  set fieldType($6.FieldType v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class UpdatePropertyResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdatePropertyResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.property_svc.v1'), createEmptyInstance: create)
    ..aOM<$5.Conflict>(1, _omitFieldNames ? '' : 'conflict', subBuilder: $5.Conflict.create)
    ..aOS(2, _omitFieldNames ? '' : 'consistency')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $5.Conflict get conflict => $_getN(0);
  @$pb.TagNumber(1)
  set conflict($5.Conflict v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasConflict() => $_has(0);
  @$pb.TagNumber(1)
  void clearConflict() => clearField(1);
  @$pb.TagNumber(1)
  $5.Conflict ensureConflict() => $_ensure(0);
...
class GetPropertiesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPropertiesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.property_svc.v1'), createEmptyInstance: create)
    ..e<$6.SubjectType>(1, _omitFieldNames ? '' : 'subjectType', $pb.PbFieldType.OE, defaultOrMaker: $6.SubjectType.SUBJECT_TYPE_UNSPECIFIED, valueOf: $6.SubjectType.valueOf, enumValues: $6.SubjectType.values)
    ..hasRequiredFields = false
  ;
  ...
  $6.SubjectType get subjectType => $_getN(0);
  @$pb.TagNumber(1)
  set subjectType($6.SubjectType v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSubjectType() => $_has(0);
  @$pb.TagNumber(1)
