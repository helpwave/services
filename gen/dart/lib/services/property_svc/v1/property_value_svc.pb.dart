...
import '../../../libs/common/v1/conflict.pb.dart' as $23;
...
class AttachPropertyValueRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttachPropertyValueRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.property_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$22.Timestamp>(7, _omitFieldNames ? '' : 'dateTimeValue', subBuilder: $22.Timestamp.create)
  ...
  @$pb.TagNumber(7)
  $22.Timestamp get dateTimeValue => $_getN(6);
  @$pb.TagNumber(7)
  set dateTimeValue($22.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDateTimeValue() => $_has(6);
  @$pb.TagNumber(7)
  void clearDateTimeValue() => clearField(7);
  @$pb.TagNumber(7)
  $22.Timestamp ensureDateTimeValue() => $_ensure(6);
...
class AttachPropertyValueResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttachPropertyValueResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.property_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$23.Conflict>(2, _omitFieldNames ? '' : 'conflict', subBuilder: $23.Conflict.create)
  ...
  @$pb.TagNumber(2)
  $23.Conflict get conflict => $_getN(1);
  @$pb.TagNumber(2)
  set conflict($23.Conflict v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConflict() => $_has(1);
  @$pb.TagNumber(2)
  void clearConflict() => clearField(2);
  @$pb.TagNumber(2)
  $23.Conflict ensureConflict() => $_ensure(1);
...
class GetAttachedPropertyValuesResponse_Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetAttachedPropertyValuesResponse.Value', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.property_svc.v1'), createEmptyInstance: create)
    ...
    ..e<$24.FieldType>(2, _omitFieldNames ? '' : 'fieldType', $pb.PbFieldType.OE, defaultOrMaker: $24.FieldType.FIELD_TYPE_UNSPECIFIED, valueOf: $24.FieldType.valueOf, enumValues: $24.FieldType.values)
    ...
    ..aOM<$22.Timestamp>(10, _omitFieldNames ? '' : 'dateTimeValue', subBuilder: $22.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $24.FieldType get fieldType => $_getN(1);
  @$pb.TagNumber(2)
  set fieldType($24.FieldType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(10)
  $22.Timestamp get dateTimeValue => $_getN(9);
  @$pb.TagNumber(10)
  set dateTimeValue($22.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasDateTimeValue() => $_has(9);
  @$pb.TagNumber(10)
  void clearDateTimeValue() => clearField(10);
  @$pb.TagNumber(10)
  $22.Timestamp ensureDateTimeValue() => $_ensure(9);
