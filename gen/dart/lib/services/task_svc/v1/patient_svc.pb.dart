...
class GetPatientResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set gender(Gender v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class GetPatientByBedResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPatientByBedResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.task_svc.v1'), createEmptyInstance: create)
    ...
    ..aOS(3, _omitFieldNames ? '' : 'notes')
    ..aOS(4, _omitFieldNames ? '' : 'bedId')
    ..e<Gender>(5, _omitFieldNames ? '' : 'gender', $pb.PbFieldType.OE, defaultOrMaker: Gender.GENDER_UNSPECIFIED, valueOf: Gender.valueOf, enumValues: Gender.values)
...
class UpdatePatientRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdatePatientRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.task_svc.v1'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'humanReadableIdentifier')
    ..aOS(3, _omitFieldNames ? '' : 'notes')
    ..e<Gender>(4, _omitFieldNames ? '' : 'gender', $pb.PbFieldType.OE, defaultOrMaker: Gender.GENDER_UNSPECIFIED, valueOf: Gender.valueOf, enumValues: Gender.values)
    ..aOM<$24.Date>(5, _omitFieldNames ? '' : 'dateOfBirth', subBuilder: $24.Date.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $24.Date get dateOfBirth => $_getN(4);
  @$pb.TagNumber(5)
  set dateOfBirth($24.Date v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDateOfBirth() => $_has(4);
  @$pb.TagNumber(5)
  void clearDateOfBirth() => clearField(5);
  @$pb.TagNumber(5)
  $24.Date ensureDateOfBirth() => $_ensure(4);
}
...
class GetPatientDetailsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPatientDetailsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.task_svc.v1'), createEmptyInstance: create)
    ...
    ..e<Gender>(10, _omitFieldNames ? '' : 'gender', $pb.PbFieldType.OE, defaultOrMaker: Gender.GENDER_UNSPECIFIED, valueOf: Gender.valueOf, enumValues: Gender.values)
  ...
  @$pb.TagNumber(10)
  Gender get gender => $_getN(9);
  @$pb.TagNumber(10)
  set gender(Gender v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  $24.Date get dateOfBirth => $_getN(10);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(11)
  $24.Date ensureDateOfBirth() => $_ensure(10);
}
...
class GetPatientListResponse_PatientWithRoomAndBed extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPatientListResponse.PatientWithRoomAndBed', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.task_svc.v1'), createEmptyInstance: create)
    ...
    ..e<Gender>(7, _omitFieldNames ? '' : 'gender', $pb.PbFieldType.OE, defaultOrMaker: Gender.GENDER_UNSPECIFIED, valueOf: Gender.valueOf, enumValues: Gender.values)
    ..aOM<$24.Date>(8, _omitFieldNames ? '' : 'dateOfBirth', subBuilder: $24.Date.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  set dateOfBirth($24.Date v) { setField(8, v); }
  @$pb.TagNumber(8)
