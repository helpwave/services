...
class CreateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$22.Timestamp>(5, _omitFieldNames ? '' : 'dueAt', subBuilder: $22.Timestamp.create)
    ..e<$25.TaskStatus>(6, _omitFieldNames ? '' : 'initialStatus', $pb.PbFieldType.OE, defaultOrMaker: $25.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $25.TaskStatus.valueOf, enumValues: $25.TaskStatus.values)
  ...
  @$pb.TagNumber(5)
  $22.Timestamp get dueAt => $_getN(4);
  @$pb.TagNumber(5)
  set dueAt($22.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDueAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearDueAt() => clearField(5);
  @$pb.TagNumber(5)
  $22.Timestamp ensureDueAt() => $_ensure(4);

  @$pb.TagNumber(6)
  $25.TaskStatus get initialStatus => $_getN(5);
  @$pb.TagNumber(6)
  set initialStatus($25.TaskStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class UpdateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$22.Timestamp>(4, _omitFieldNames ? '' : 'dueAt', subBuilder: $22.Timestamp.create)
    ..e<$25.TaskStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $25.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $25.TaskStatus.valueOf, enumValues: $25.TaskStatus.values)
  ...
  @$pb.TagNumber(4)
  $22.Timestamp get dueAt => $_getN(3);
  @$pb.TagNumber(4)
  set dueAt($22.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDueAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearDueAt() => clearField(4);
  @$pb.TagNumber(4)
  $22.Timestamp ensureDueAt() => $_ensure(3);

  @$pb.TagNumber(5)
  $25.TaskStatus get status => $_getN(4);
  @$pb.TagNumber(5)
  set status($25.TaskStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class UpdateTaskResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTaskResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ..aOM<$23.Conflict>(1, _omitFieldNames ? '' : 'conflict', subBuilder: $23.Conflict.create)
    ..aOS(2, _omitFieldNames ? '' : 'consistency')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $23.Conflict get conflict => $_getN(0);
  @$pb.TagNumber(1)
  set conflict($23.Conflict v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasConflict() => $_has(0);
  @$pb.TagNumber(1)
  void clearConflict() => clearField(1);
  @$pb.TagNumber(1)
  $23.Conflict ensureConflict() => $_ensure(0);
...
class GetTaskResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTaskResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..e<$25.TaskStatus>(6, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $25.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $25.TaskStatus.valueOf, enumValues: $25.TaskStatus.values)
    ..aOM<$22.Timestamp>(7, _omitFieldNames ? '' : 'createdAt', subBuilder: $22.Timestamp.create)
    ..aOB(8, _omitFieldNames ? '' : 'public')
    ..aOM<$22.Timestamp>(9, _omitFieldNames ? '' : 'dueAt', subBuilder: $22.Timestamp.create)
  ...
  @$pb.TagNumber(6)
  $25.TaskStatus get status => $_getN(5);
  @$pb.TagNumber(6)
  set status($25.TaskStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(9)
  $22.Timestamp get dueAt => $_getN(8);
  @$pb.TagNumber(9)
  set dueAt($22.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasDueAt() => $_has(8);
  @$pb.TagNumber(9)
  void clearDueAt() => clearField(9);
  @$pb.TagNumber(9)
  $22.Timestamp ensureDueAt() => $_ensure(8);
...
class GetTasksByPatientResponse_Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTasksByPatientResponse.Task', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$22.Timestamp>(8, _omitFieldNames ? '' : 'dueAt', subBuilder: $22.Timestamp.create)
    ...
    ..aOM<$22.Timestamp>(11, _omitFieldNames ? '' : 'createdAt', subBuilder: $22.Timestamp.create)
    ..aOS(12, _omitFieldNames ? '' : 'consistency')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $22.Timestamp get dueAt => $_getN(7);
  @$pb.TagNumber(8)
  set dueAt($22.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasDueAt() => $_has(7);
  @$pb.TagNumber(8)
  void clearDueAt() => clearField(8);
  @$pb.TagNumber(8)
  $22.Timestamp ensureDueAt() => $_ensure(7);
  ...
  @$pb.TagNumber(11)
  $22.Timestamp get createdAt => $_getN(10);
  @$pb.TagNumber(11)
  set createdAt($22.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasCreatedAt() => $_has(10);
  @$pb.TagNumber(11)
  void clearCreatedAt() => clearField(11);
  @$pb.TagNumber(11)
  $22.Timestamp ensureCreatedAt() => $_ensure(10);
...
class GetTasksByPatientSortedByStatusResponse_Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTasksByPatientSortedByStatusResponse.Task', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOB(6, _omitFieldNames ? '' : 'public')
    ..aOM<$22.Timestamp>(7, _omitFieldNames ? '' : 'dueAt', subBuilder: $22.Timestamp.create)
    ...
    ..aOM<$22.Timestamp>(10, _omitFieldNames ? '' : 'createdAt', subBuilder: $22.Timestamp.create)
  ...
  @$pb.TagNumber(7)
  $22.Timestamp get dueAt => $_getN(6);
  @$pb.TagNumber(7)
  set dueAt($22.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDueAt() => $_has(6);
  @$pb.TagNumber(7)
  void clearDueAt() => clearField(7);
  @$pb.TagNumber(7)
  $22.Timestamp ensureDueAt() => $_ensure(6);
  ...
  @$pb.TagNumber(10)
  $22.Timestamp get createdAt => $_getN(9);
  @$pb.TagNumber(10)
  set createdAt($22.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasCreatedAt() => $_has(9);
  @$pb.TagNumber(10)
  void clearCreatedAt() => clearField(10);
  @$pb.TagNumber(10)
  $22.Timestamp ensureCreatedAt() => $_ensure(9);
