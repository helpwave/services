...
import '../../../libs/common/v1/conflict.pb.dart' as $6;
import 'types.pbenum.dart' as $7;
...
class CreateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$8.Timestamp>(5, _omitFieldNames ? '' : 'dueAt', subBuilder: $8.Timestamp.create)
    ..e<$7.TaskStatus>(6, _omitFieldNames ? '' : 'initialStatus', $pb.PbFieldType.OE, defaultOrMaker: $7.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $7.TaskStatus.valueOf, enumValues: $7.TaskStatus.values)
  ...
  @$pb.TagNumber(5)
  $8.Timestamp get dueAt => $_getN(4);
  @$pb.TagNumber(5)
  set dueAt($8.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDueAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearDueAt() => clearField(5);
  @$pb.TagNumber(5)
  $8.Timestamp ensureDueAt() => $_ensure(4);

  @$pb.TagNumber(6)
  $7.TaskStatus get initialStatus => $_getN(5);
  @$pb.TagNumber(6)
  set initialStatus($7.TaskStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class UpdateTaskRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTaskRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOM<$8.Timestamp>(4, _omitFieldNames ? '' : 'dueAt', subBuilder: $8.Timestamp.create)
    ..e<$7.TaskStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $7.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $7.TaskStatus.valueOf, enumValues: $7.TaskStatus.values)
  ...
  @$pb.TagNumber(4)
  $8.Timestamp get dueAt => $_getN(3);
  @$pb.TagNumber(4)
  set dueAt($8.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDueAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearDueAt() => clearField(4);
  @$pb.TagNumber(4)
  $8.Timestamp ensureDueAt() => $_ensure(3);

  @$pb.TagNumber(5)
  $7.TaskStatus get status => $_getN(4);
  @$pb.TagNumber(5)
  set status($7.TaskStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class UpdateTaskResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTaskResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ..aOM<$6.Conflict>(1, _omitFieldNames ? '' : 'conflict', subBuilder: $6.Conflict.create)
    ..aOS(2, _omitFieldNames ? '' : 'consistency')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $6.Conflict get conflict => $_getN(0);
  @$pb.TagNumber(1)
  set conflict($6.Conflict v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasConflict() => $_has(0);
  @$pb.TagNumber(1)
  void clearConflict() => clearField(1);
  @$pb.TagNumber(1)
  $6.Conflict ensureConflict() => $_ensure(0);
...
class GetTaskResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTaskResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..e<$7.TaskStatus>(6, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $7.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $7.TaskStatus.valueOf, enumValues: $7.TaskStatus.values)
    ..aOM<$8.Timestamp>(7, _omitFieldNames ? '' : 'createdAt', subBuilder: $8.Timestamp.create)
    ..aOB(8, _omitFieldNames ? '' : 'public')
    ..aOM<$8.Timestamp>(9, _omitFieldNames ? '' : 'dueAt', subBuilder: $8.Timestamp.create)
  ...
  @$pb.TagNumber(6)
  $7.TaskStatus get status => $_getN(5);
  @$pb.TagNumber(6)
  set status($7.TaskStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(9)
  $8.Timestamp get dueAt => $_getN(8);
  @$pb.TagNumber(9)
  set dueAt($8.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasDueAt() => $_has(8);
  @$pb.TagNumber(9)
  void clearDueAt() => clearField(9);
  @$pb.TagNumber(9)
  $8.Timestamp ensureDueAt() => $_ensure(8);
...
class GetTasksByPatientResponse_Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTasksByPatientResponse.Task', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..aOS(3, _omitFieldNames ? '' : 'description')
    ..e<$7.TaskStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $7.TaskStatus.TASK_STATUS_UNSPECIFIED, valueOf: $7.TaskStatus.valueOf, enumValues: $7.TaskStatus.values)
    ..aOS(5, _omitFieldNames ? '' : 'assignedUserId')
    ..aOS(6, _omitFieldNames ? '' : 'patientId')
    ..aOB(7, _omitFieldNames ? '' : 'public')
    ..aOM<$8.Timestamp>(8, _omitFieldNames ? '' : 'dueAt', subBuilder: $8.Timestamp.create)
    ...
    ..aOM<$8.Timestamp>(11, _omitFieldNames ? '' : 'createdAt', subBuilder: $8.Timestamp.create)
    ..aOS(12, _omitFieldNames ? '' : 'consistency')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $7.TaskStatus get status => $_getN(3);
  @$pb.TagNumber(4)
  set status($7.TaskStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  $8.Timestamp get dueAt => $_getN(7);
  @$pb.TagNumber(8)
  set dueAt($8.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasDueAt() => $_has(7);
  @$pb.TagNumber(8)
  void clearDueAt() => clearField(8);
  @$pb.TagNumber(8)
  $8.Timestamp ensureDueAt() => $_ensure(7);
  ...
  @$pb.TagNumber(11)
  $8.Timestamp get createdAt => $_getN(10);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(11)
  $8.Timestamp ensureCreatedAt() => $_ensure(10);
...
class GetTasksByPatientSortedByStatusResponse_Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTasksByPatientSortedByStatusResponse.Task', package: const $pb.PackageName(_omitMessageNames ? '' : 'services.tasks_svc.v1'), createEmptyInstance: create)
    ...
    ..aOB(6, _omitFieldNames ? '' : 'public')
    ..aOM<$8.Timestamp>(7, _omitFieldNames ? '' : 'dueAt', subBuilder: $8.Timestamp.create)
  ...
  @$pb.TagNumber(7)
  $8.Timestamp get dueAt => $_getN(6);
  @$pb.TagNumber(7)
  set dueAt($8.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDueAt() => $_has(6);
  @$pb.TagNumber(7)
  void clearDueAt() => clearField(7);
  @$pb.TagNumber(7)
  $8.Timestamp ensureDueAt() => $_ensure(6);
