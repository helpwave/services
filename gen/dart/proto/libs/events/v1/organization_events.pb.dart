...
class OrganizationCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OrganizationCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.libs.events.v1'), createEmptyInstance: create)
