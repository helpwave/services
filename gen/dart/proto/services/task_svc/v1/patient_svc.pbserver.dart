...
abstract class PatientServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$3.GetRecentPatientsResponse> getRecentPatients($pb.ServerContext ctx, $3.GetRecentPatientsRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'GetRecentPatients': return $3.GetRecentPatientsRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'GetRecentPatients': return this.getRecentPatients(ctx, request as $3.GetRecentPatientsRequest);
