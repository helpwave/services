...
const UpdateSubTaskRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'done', '3': 3, '4': 1, '5': 8, '9': 1, '10': 'done', '17': true},
  ],
  '8': const [
    const {'1': '_title'},
    const {'1': '_done'},
...
final $typed_data.Uint8List updateSubTaskRequestDescriptor = $convert.base64Decode('ChRVcGRhdGVTdWJUYXNrUmVxdWVzdBIOCgJpZBgBIAEoCVICaWQSGQoFdGl0bGUYAiABKAlIAFIFdGl0bGWIAQESFwoEZG9uZRgDIAEoCEgBUgRkb25liAEBQggKBl90aXRsZUIHCgVfZG9uZQ==');
