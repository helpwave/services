...
class PrelimAuthRequestRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PrelimAuthRequestRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.auth_svc.v1'), createEmptyInstance: create)
...
class PrelimAuthRequestResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PrelimAuthRequestResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.auth_svc.v1'), createEmptyInstance: create)
...
class AuthServiceApi {
  ...
  $async.Future<PrelimAuthRequestResponse> prelimAuthRequest($pb.ClientContext? ctx, PrelimAuthRequestRequest request) =>
    _client.invoke<PrelimAuthRequestResponse>(ctx, 'AuthService', 'PrelimAuthRequest', request, PrelimAuthRequestResponse())
  ;
}
