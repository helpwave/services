...
abstract class WardServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$8.GetWardsOverviewResponse> getWardsOverview($pb.ServerContext ctx, $8.GetWardsOverviewRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'GetWardsOverview': return $8.GetWardsOverviewRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'GetWardsOverview': return this.getWardsOverview(ctx, request as $8.GetWardsOverviewRequest);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
