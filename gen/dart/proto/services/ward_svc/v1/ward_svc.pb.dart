...
class GetWardOverviewsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetWardOverviewsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.ward_svc.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class GetWardOverviewsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetWardOverviewsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'proto.services.ward_svc.v1'), createEmptyInstance: create)
