...
const GetWardsOverviewResponse$json = {
  ...
  '2': [
    {'1': 'wards', '3': 1, '4': 3, '5': 11, '6': '.proto.services.ward_svc.v1.GetWardsOverviewResponse.Ward', '10': 'wards'},
  ],
...
final $typed_data.Uint8List getWardsOverviewResponseDescriptor = $convert.base64Decode(
    'ChhHZXRXYXJkc092ZXJ2aWV3UmVzcG9uc2USTwoFd2FyZHMYASADKAsyOS5wcm90by5zZXJ2aW'
    'Nlcy53YXJkX3N2Yy52MS5HZXRXYXJkc092ZXJ2aWV3UmVzcG9uc2UuV2FyZFIFd2FyZHMangEK'
...
const $core.Map<$core.String, $core.dynamic> WardServiceBase$json = {
  ...
  '2': [
    ...
    {'1': 'GetWardsOverview', '2': '.proto.services.ward_svc.v1.GetWardsOverviewRequest', '3': '.proto.services.ward_svc.v1.GetWardsOverviewResponse', '4': {}},
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> WardServiceBase$messageJson = {
  ...
  '.proto.services.ward_svc.v1.GetWardsOverviewRequest': GetWardsOverviewRequest$json,
  '.proto.services.ward_svc.v1.GetWardsOverviewResponse': GetWardsOverviewResponse$json,
  '.proto.services.ward_svc.v1.GetWardsOverviewResponse.Ward': GetWardsOverviewResponse_Ward$json,
};
...
final $typed_data.Uint8List wardServiceDescriptor = $convert.base64Decode(
    ...
    'ChBHZXRXYXJkc092ZXJ2aWV3EjMucHJvdG8uc2VydmljZXMud2FyZF9zdmMudjEuR2V0V2FyZH'
    'NPdmVydmlld1JlcXVlc3QaNC5wcm90by5zZXJ2aWNlcy53YXJkX3N2Yy52MS5HZXRXYXJkc092'
    'ZXJ2aWV3UmVzcG9uc2UiAA==');
