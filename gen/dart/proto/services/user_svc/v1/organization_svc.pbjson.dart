...
final $typed_data.Uint8List acceptInvitationRequestDescriptor = $convert.base64Decode('ChdBY2NlcHRJbnZpdGF0aW9uUmVxdWVzdBIjCg1pbnZpdGF0aW9uX2lkGAEgASgJUgxpbnZpdGF0aW9uSWQ=');
...
const DeclineInvitationRequest$json = const {
...
final $typed_data.Uint8List declineInvitationRequestDescriptor = $convert.base64Decode('ChhEZWNsaW5lSW52aXRhdGlvblJlcXVlc3QSIwoNaW52aXRhdGlvbl9pZBgBIAEoCVIMaW52aXRhdGlvbklk');
@$core.Deprecated('Use declineInvitationResponseDescriptor instead')
const DeclineInvitationResponse$json = const {
  '1': 'DeclineInvitationResponse',
};

/// Descriptor for `DeclineInvitationResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List declineInvitationResponseDescriptor = $convert.base64Decode('ChlEZWNsaW5lSW52aXRhdGlvblJlc3BvbnNl');
const $core.Map<$core.String, $core.dynamic> OrganizationServiceBase$json = const {
  ...
  '2': const [
    ...
    const {'1': 'DeclineInvitation', '2': '.proto.services.user_svc.v1.DeclineInvitationRequest', '3': '.proto.services.user_svc.v1.DeclineInvitationResponse', '4': const {}},
  ],
};
...
final $typed_data.Uint8List organizationServiceDescriptor = $convert.base64Decode('');
