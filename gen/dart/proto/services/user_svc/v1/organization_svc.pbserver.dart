...
abstract class OrganizationServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$8.GetMembersByOrganisationResponse> getMembersByOrganisation($pb.ServerContext ctx, $8.GetMembersByOrganisationRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'GetMembersByOrganisation': return $8.GetMembersByOrganisationRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'GetMembersByOrganisation': return this.getMembersByOrganisation(ctx, request as $8.GetMembersByOrganisationRequest);
