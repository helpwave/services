...
abstract class OrganizationServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$9.GetInvitationsByOrganizationResponse> getInvitationsByOrganization($pb.ServerContext ctx, $9.GetInvitationsByOrganizationRequest request);
  ...
  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      ...
      case 'GetInvitationsByOrganization': return $9.GetInvitationsByOrganizationRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      ...
      case 'GetInvitationsByOrganization': return this.getInvitationsByOrganization(ctx, request as $9.GetInvitationsByOrganizationRequest);
