...
func (x *CreateUserEvent) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CreateUserEvent) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *CreateUserEvent) GetNickname() string {
	if x != nil {
		return x.Nickname
	}
	return ""
...
func (x *CreateUserEvent) GetFullName() string {
	if x != nil {
		return x.FullName
	}
	return ""
...
var file_user_events_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x6f, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x6e, 0x69, 0x63, 0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x75, 0x6c, 0x6c,
	0x4e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x75, 0x6c, 0x6c,
	0x4e, 0x61, 0x6d, 0x65, 0x42, 0x0e, 0x5a, 0x0c, 0x75, 0x73, 0x65, 0x72, 0x2d, 0x73, 0x76, 0x63,
...
var file_user_events_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_user_events_proto_goTypes = []interface{}{
	(*CreateUserEvent)(nil), // 0: CreateUserEvent
}
