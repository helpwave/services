...
func (a *PropertyValueAggregate) CreatePropertyValue(ctx context.Context, propertyID uuid.UUID, value interface{}) error {
	id := a.GetID()

	event, err := propertyEventsV1.NewPropertyValueCreatedEvent(a, id, propertyID, value)
	if err != nil {
		return err
	}
