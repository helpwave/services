...
const getRoomsWithBedsWithActivePatientsForOrganization = `-- name: GetRoomsWithBedsWithActivePatientsForOrganization :many
SELECT
	rooms.id as room_id,
	rooms.name as room_name,
	beds.id as bed_id,
...
type GetRoomsWithBedsWithActivePatientsForOrganizationRow struct {
	RoomID                         uuid.UUID
	RoomName                       string
	BedID                          uuid.NullUUID
	BedName                        *string
...
func (q *Queries) GetRoomsWithBedsWithActivePatientsForOrganization(ctx context.Context, organizationID uuid.UUID) ([]GetRoomsWithBedsWithActivePatientsForOrganizationRow, error) {
	rows, err := q.db.Query(ctx, getRoomsWithBedsWithActivePatientsForOrganization, organizationID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []GetRoomsWithBedsWithActivePatientsForOrganizationRow{}
	for rows.Next() {
		var i GetRoomsWithBedsWithActivePatientsForOrganizationRow
		if err := rows.Scan(
			&i.RoomID,
			&i.RoomName,
			&i.BedID,
...
const getRoomsWithBedsWithActivePatientsForWard = `-- name: GetRoomsWithBedsWithActivePatientsForWard :many
SELECT
	rooms.id as room_id,
	rooms.name as room_name,
	beds.id as bed_id,
...
type GetRoomsWithBedsWithActivePatientsForWardRow struct {
	RoomID                         uuid.UUID
	RoomName                       string
	BedID                          uuid.NullUUID
	BedName                        *string
...
func (q *Queries) GetRoomsWithBedsWithActivePatientsForWard(ctx context.Context, wardID uuid.UUID) ([]GetRoomsWithBedsWithActivePatientsForWardRow, error) {
	rows, err := q.db.Query(ctx, getRoomsWithBedsWithActivePatientsForWard, wardID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []GetRoomsWithBedsWithActivePatientsForWardRow{}
	for rows.Next() {
		var i GetRoomsWithBedsWithActivePatientsForWardRow
		if err := rows.Scan(
			&i.RoomID,
			&i.RoomName,
			&i.BedID,
