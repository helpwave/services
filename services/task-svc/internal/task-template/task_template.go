...
import (
	...
	taskTemplateModels "task-svc/internal/task-template/models"
)
...
func (ServiceServer) CreateTaskTemplate(ctx context.Context, req *pb.CreateTaskTemplateRequest) (*pb.CreateTaskTemplateResponse, error) {
	...
	taskTemplate := taskTemplateModels.TaskTemplate{
		Base:           taskTemplateModels.Base{Name: req.Name, Description: req.Description},
	...
	var subtasks []taskTemplateModels.TaskTemplateSubtask
	if req.Subtasks != nil {
		subtasks = hwutil.Map(req.Subtasks, func(subtask *pb.CreateTaskTemplateRequest_SubTask) taskTemplateModels.TaskTemplateSubtask {
			return taskTemplateModels.TaskTemplateSubtask{Name: subtask.Name, TaskTemplateID: taskTemplate.ID}
		})
	}
...
func (ServiceServer) GetAllTaskTemplates(ctx context.Context, _ *pb.GetAllTaskTemplatesRequest) (*pb.GetAllTaskTemplatesResponse, error) {
	...
	var taskTemplates []taskTemplateModels.TaskTemplate
	...
	var mappedTaskTemplates = hwutil.Map(taskTemplates, func(taskTemplate taskTemplateModels.TaskTemplate) *pb.GetAllTaskTemplatesResponse_TaskTemplate {
		var mappedSubtasks = hwutil.Map(taskTemplate.SubTasks, func(subtask taskTemplateModels.TaskTemplateSubtask) *pb.GetAllTaskTemplatesResponse_TaskTemplate_SubTask {
...
func (ServiceServer) DeleteTaskTemplate(ctx context.Context, req *pb.DeleteTaskTemplateRequest) (*pb.DeleteTaskTemplateResponse, error) {
	...
	taskTemplate := taskTemplateModels.TaskTemplate{ID: id}
...
func (ServiceServer) DeleteTaskTemplateSubTask(ctx context.Context, req *pb.DeleteTaskTemplateSubTaskRequest) (*pb.DeleteTaskTemplateSubTaskResponse, error) {
	...
	taskTemplateSubtask := taskTemplateModels.TaskTemplateSubtask{ID: id}
...
func (ServiceServer) UpdateTaskTemplateSubtask(ctx context.Context, req *pb.UpdateTaskTemplateSubTaskRequest) (*pb.UpdateTaskTemplateSubTaskResponse, error) {
	...
	taskTemplate := taskTemplateModels.TaskTemplateSubtask{ID: id}
...
func (ServiceServer) CreateTaskTemplateSubTask(ctx context.Context, req *pb.CreateTaskTemplateSubTaskRequest) (*pb.CreateTaskTemplateSubTaskResponse, error) {
	...
	taskTemplateSubtask := taskTemplateModels.TaskTemplateSubtask{
...
func (ServiceServer) GetAllTaskTemplatesByCreator(ctx context.Context, req *pb.GetAllTaskTemplatesByCreatorRequest) (*pb.GetAllTaskTemplatesByCreatorResponse, error) {
	...
	var mappedTaskTemplates = hwutil.Map(taskTemplates, func(taskTemplate taskTemplateModels.TaskTemplate) *pb.GetAllTaskTemplatesByCreatorResponse_TaskTemplate {
		var mappedSubtasks = hwutil.Map(taskTemplate.SubTasks, func(subtask taskTemplateModels.TaskTemplateSubtask) *pb.GetAllTaskTemplatesByCreatorResponse_TaskTemplate_SubTask {
...
func (ServiceServer) GetAllTaskTemplatesByWard(ctx context.Context, req *pb.GetAllTaskTemplatesByWardRequest) (*pb.GetAllTaskTemplatesByWardResponse, error) {
	...
	var mappedTaskTemplates = hwutil.Map(taskTemplates, func(taskTemplate taskTemplateModels.TaskTemplate) *pb.GetAllTaskTemplatesByWardResponse_TaskTemplate {
		var mappedSubtasks = hwutil.Map(taskTemplate.SubTasks, func(subtask taskTemplateModels.TaskTemplateSubtask) *pb.GetAllTaskTemplatesByWardResponse_TaskTemplate_SubTask {
