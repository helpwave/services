...
func (a *PatientAggregate) UnassignBed(ctx context.Context, currentBedID uuid.NullUUID) error {
	if !currentBedID.Valid {
		// Patient cant be unassigned if not assigned
		return nil
	}
