...
type UpdatePatientCommandHandler func(ctx context.Context, patientID uuid.UUID, expConsistency *common.ConsistencyToken, humanReadableIdentifier, notes *string) (common.ConsistencyToken, *common.Conflict[*models.Patient], error)

func NewUpdatePatientCommandHandler(as hwes.AggregateStore) UpdatePatientCommandHandler {
	return func(ctx context.Context, patientID uuid.UUID, expConsistency *common.ConsistencyToken, humanReadableIdentifier, notes *string) (common.ConsistencyToken, *common.Conflict[*models.Patient], error) {
