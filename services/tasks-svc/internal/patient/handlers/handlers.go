	...
	return &Handlers{
		...
		Queries: &Queries{
			V1: &queriesV1.PatientQueries{
				...
				GetPatientByBed:           queriesV1.NewGetPatientByBedQueryHandler(as),
				GetPatientsByWard:         queriesV1.NewGetPatientsByWardQueryHandler(as),
				GetPatientDetailsByID:     queriesV1.NewGetPatientWithDetailsByIDQueryHandler(as),
				GetAllPatientsWithDetails: queriesV1.NewGetAllPatientsWithDetailsQueryHandler(as),
			},
		},
	}
}
